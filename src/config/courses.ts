...
// Cover images mapped by course ID — sourced from public/images/
export const COURSE_COVER_IMAGES: Record<string, string> = {
  // Software Engineering
  'code-starter':      '/images/Code-starter-2.png',
  'fullstack':         '/images/illustrations/course-software.svg',
  'mobile-dev':        '/images/illustrations/course-software.svg',
  'devops-cloud':      '/images/illustrations/course-software.svg',
  'cybersecurity':     '/images/IT Support Course.png',
  'scratch-python':    '/images/python-programming.png',
  'web-design-teens':  '/images/Code-starter-2.png',
  'game-dev':          '/images/illustrations/course-software.svg',
  // ICDL
  'icdl-core':             '/images/ICDL-core-course.png',
  'icdl-advanced':         '/images/ICDL-core-course.png',
  'icdl-professional':     '/images/ICDL-core-course.png',
  'icdl-digital-citizen':  '/images/ICDL-core-course.png',
  // CCNA
  'ccna-1':            '/images/Cisco.png',
  'ccna-2':            '/images/Cisco.png',
  'ccna-3':            '/images/Cisco.png',
  'ccna-exam-prep':    '/images/illustrations/course-networking.svg',
  // AI
  'ai-fundamentals':   '/images/illustrations/course-ai.svg',
  'ml-python':         '/images/python-programming.png',
  'genai-llm':         '/images/illustrations/course-ai.svg',
  'ai-for-business':   '/images/Codevertex-Digital-Marketing.jpg',
  // Data Analytics
  'data-python':       '/images/illustrations/course-data.svg',
  'data-powerbi':      '/images/Codevertex-Digital-Marketing.jpg',
  'data-sql':          '/images/illustrations/course-data.svg',
  'data-advanced':     '/images/illustrations/course-data.svg',
};
...
export const COURSE_CATEGORIES: CourseCategory[] = [
  ...
  },
  {
    ...
    courses: [
      {
        id: 'icdl-core',
        name: 'ICDL Core (Levels 1–3)',
        shortName: 'ICDL Core',
        duration: '6 weeks',
        mode: 'In-person / Online',
        price: 12000,
        currency: 'KES',
        description: 'Essential computer skills: OS navigation, word processing, spreadsheets, presentations, internet & email.',
        longDescription: 'The ICDL Core certification covers the fundamental digital skills every professional needs. This qualification is internationally recognised and accepted by employers worldwide, including the Kenyan public service.',
        outcomes: ['File management', 'Word processing (Word/Writer)', 'Spreadsheets (Excel/Calc)', 'Presentations (PowerPoint)', 'Internet safety', 'Email professionalism'],
        brochure: '/brochures/Codevertex_Digitika_Program_Cert_Samples.pdf',
        careerPaths: ['Office Administrator', 'Data Entry Specialist', 'Any professional role requiring computer literacy'],
        prerequisites: ['Basic ability to use a computer'],
      },
      {
        id: 'icdl-advanced',
        name: 'ICDL Advanced (Levels 4–5)',
        shortName: 'ICDL Advanced',
        duration: '8 weeks',
        mode: 'In-person / Online',
        price: 18000,
        currency: 'KES',
        description: 'Advanced modules in document processing, spreadsheets, databases and presentations for power users.',
        longDescription: 'Build on your ICDL Core skills with advanced features — complex formulas, database queries, document automation, and advanced presentation techniques that set you apart in the workplace.',
        outcomes: ['Advanced Excel/Calc formulas', 'Database design & queries', 'Advanced presentations', 'Document automation', 'Data analysis'],
        careerPaths: ['Office Manager', 'Data Analyst', 'Administrative Officer', 'Finance Assistant'],
        prerequisites: ['ICDL Core or equivalent experience'],
      },
      {
        id: 'icdl-professional',
        name: 'ICDL Professional',
        shortName: 'ICDL Professional',
        duration: '10 weeks',
        mode: 'Hybrid',
        price: 24000,
        currency: 'KES',
        description: 'Industry-level modules: IT security, project planning, 2D CAD, and computational thinking.',
        longDescription: 'The highest tier of ICDL certification. Covers IT security for business, digital project planning, 2D CAD design, and computational thinking — skills valued in IT departments, project management roles, and engineering firms.',
        outcomes: ['IT Security fundamentals', 'Project planning tools', 'CAD basics', 'Computational thinking', 'Digital project management'],
        careerPaths: ['IT Officer', 'Project Manager', 'Technical Administrator', 'Systems Analyst'],
        prerequisites: ['ICDL Advanced or strong general computer skills'],
      },
      {
        id: 'icdl-citizen',

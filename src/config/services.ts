...
export const POWER_SUITE: PowerSuiteProduct[] = [
  ...
  },
  {
    id: 'automation',
    name: 'AI & Automation',
    tag: 'Custom AI Assistants, BI & Workflow Automation',
    description: 'We build tailored AI assistants, business intelligence dashboards, and workflow automation solutions for your organisation — from custom chatbots and NLP agents to data pipelines and process automation.',
    icon: Brain,
    url: '/contact',
    color: '#0EA5E9',
    img: '/images/illustrations/product-vera.svg',
    status: 'beta',
    highlights: ['Custom AI chatbots and virtual assistants', 'Business intelligence and BI dashboards', 'Workflow and process automation'],
  },
  {
    id: 'notifications',
